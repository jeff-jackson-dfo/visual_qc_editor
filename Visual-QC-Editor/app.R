...
lats <- c(44.21667, 43.78333, 43.58333, 43.58333, 43.91667, 44.1, 
          44.11833, 44.09111, 44.005)
longs <- c(-59.1, -58.5833333, -58.5833333, -59.1333333, -59.1333333, -59.3333333, 
           -59.13722, -59.0722222, )

zone1 <- cbind(c(, ), c(, ))

list1 <- 7:31
slist1 <- as.character(list1)
attr <- data.frame(a = 1:3, b = 3:1, row.names = slist1)
    ...
    fillRow(flex = c(1,4),
        ...
        tabsetPanel(
            ...
            tabPanel("Leaflet Map",
                     ...
                     div(style = "height:1000px;", leafletOutput("mymap"))
            )
        )
    )
)
